...
public class InvoiceDAO {
    ...
    public void updateOverdueInvoices(String clientId) {
        String sqlUpdate = "UPDATE Invoice SET status = 'OVERDUE' WHERE dueDate < CURDATE() AND status = 'UNPAID' AND clientId = ?";
        String sqlCount = "SELECT COUNT(*) FROM Invoice WHERE clientId = ? AND status = 'OVERDUE'";
