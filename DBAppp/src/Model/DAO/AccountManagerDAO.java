...
public class AccountManagerDAO {
    ...
    public List<AccountManager> getAllActiveManagers() {
        List<AccountManager> activeManagers = new ArrayList<>();
        String sql = "SELECT managerId, name, contactInfo, branchId, employment_status " +
                "FROM AccountManager " +
    ...
    public List<AccountManager> getManagersByBranchID(String branchId) {
        List<AccountManager> managers = new ArrayList<>();
        String sql = "SELECT managerId, name,contactInfo, branchId, employment_status " +
    ...
    public boolean checkManagerExists(String clientName) {
        String sql = "SELECT COUNT(*) FROM AccountManager WHERE LOWER(TRIM(name)) = LOWER(TRIM(?))";
        try (Connection conn = DBConnection.getConnection();
             PreparedStatement stmt = conn.prepareStatement(sql)) {
