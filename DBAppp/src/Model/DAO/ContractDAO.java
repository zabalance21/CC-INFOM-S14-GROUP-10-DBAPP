...
public class ContractDAO {
    ...
    public void addContract(Contract contract) {
        String sql = "INSERT INTO Contract (contractId, clientId, managerId, startDate, endDate) VALUES ( ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            stmt.setDate(4, java.sql.Date.valueOf(contract.getStartDate())); // if contract.getStartDate() returns LocalDate
            stmt.setDate(5, java.sql.Date.valueOf(contract.getEndDate()));   // same here
    ...
    public List<Contract> getContractsByManagerID(String managerId) {
        List<Contract> contracts = new ArrayList<>();
        String sql = "SELECT contractId, clientId, managerId, startDate, endDate, contract_status " +
