...
public class Client {
    ...
    public String toString() {
        return String.format("Client ID: %s | Client Name: %s | Email: %s | Phone: %s | Address: %s | Status : %s \n", this.clientId, this.name, this.email, this.phone, this.address, this.status);
    }
}
